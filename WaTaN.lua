...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1756511631,1987201540,1510678973,1965534755,1987201540}   
...
var = '𓆪مــبـرمج ِالســورس𓆩'
elseif tonumber(user_id) == tonumber(1965534755) then
var = '𓆪²مــاَلـك الـسـورس𓆩'
elseif tonumber(user_id) == tonumber(1510678973) then
var = '𓆪²مــبـرمج ِالســورس𓆩'
elseif tonumber(user_id) == tonumber(1987201540) then
var = '𓆪مــاَلـك الـسـورس𓆩'
elseif tonumber(user_id) == tonumber(1510678973) then
var = '𓆪مــطـور الـسـورس𓆩'
elseif tonumber(user_id) == tonumber(SUDO) then
var = '𓆪الـمـطـور الاسـاسي𓆩'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "𓆪²الـمـطـور الاسـاسي𓆩"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
local UserName = (data.username_ or "elmalk10")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'الملك') 
local DRAGON_Msg = { 
...
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
else
...
local Text = ' 🌏تم ارسال الملصق من 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n - '..Name
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/ttimo_2lby"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == '𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس الملك ادخل وتابع الجديد](t.me/elmalk10)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼', url="t.me/elmalk10"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس الملك ادخل وتابع الجديد](t.me/elmalk10)
]] 
keyboard = {}  
...
local Text = [[ 
[CH](t.me/elmalk10)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/elmalk10"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n 🌏 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'elmalk10')..')'
status  = '\n 🌏 تم ترقيته مطور'
...
usertext = '\n 🌏 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'elmalk10')..')'
status  = '\n 🌏 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ?? الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'elmalk10')..') \n 🌏 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "الملك")
...
send(msg.chat_id_,0," 🌏 الـعـضو  : {["..data.first_name_.."](T.ME/elmalk10)}\n 🌏 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🌏 عذرا  ⇇{["..data.first_name_.."](T.ME/elmalk10)}\n 🌏 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
[🎗╎ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚍𝚎𝚊𝚛 ](t.me/ttimo_2lby)
[🚶‍♂╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙶𝚁𝙰𝙼 ](t.me/J_A_B_W_A)
[ ☠╎ 𝚂𝚃𝚁𝙻𝚅𝙴 𝙵𝙾𝚁 𝚃??𝙴 𝙱𝙴𝚂𝚃 ](t.me/J_P_T)
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
•  𝖼𝗁 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲](t.me/elmalk10)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = ' ❨ 𝑻𝑰𝑴𝑶❩',url="t.me/ttimo_2lby"}},
{{text = ' ❨𝑴𝑶??𝑻𝑨𝑭𝑨❩',url="t.me/J_A_B_W_A"}},
{{text = ' ❨𝑯𝑹𝑩𝒀 ❩',url="t.me/J_P_T"}},
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼',url="t.me/elmalk10"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5 
...
if text == 'مصطفى ' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج مصطفى لو حاب تتواصل معاه
اتبع الزر إلى تحت ↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𝑴𝑶𝑺𝑻𝑨𝑭𝑨❩', url="t.me/J_A_B_W_A"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
 🌏 من أحسن السورسات على التليجرام سورس الملك 🌏
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/hhuurueu_bot"}}, 
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼', url="t.me/elmalk10"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G_2/107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🌏 اصدار سورس الملك{ 4x☆}')
end
...
local Text = [[
[ 𖠪 اهلا بك في سورس الملك الجمدان 𖠪](http://t.me/elmalk10)
[ 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪](http://t.me/elmalk10)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𝑻𝑰𝑴𝑶❩',url="t.me/ttimo_2lby"}},
...
if text == 'تيمو' or text == 'تيمو' or text == 'مطور السورس'  then
local Text = [[
تيمو مالك السورس لو حاب تتواصل معاه اتبع الازرار ل ⬇️💕
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨𝑻𝑰𝑴𝑶 ❩',url="t.me/ttimo_2lby"}},
...
if text == 'ححربي' or text == 'حربي' or text == 'مطور السورس'  then
local Text = [[
حـربي مطور سورس الملك لو حاب تتواصل معه ل ⬇️💕
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𝑯𝑹𝑩𝒀❩',url="t.me/J_P_T"}},
...
if text == '.. ' or text == 'عايز بوت مجاني' or text == 'عايزه بوت مجاني'  then
local Text = [[
مالك تيمو لو حاب تتواصل معه ل ⬇️💕
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𝑻𝑰𝑴𝑶❩',url="t.me/ttimo_2lby"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/TWASL_TIMO_BOT"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/elmalk10_bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_I_K_I_N_G_2/114/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/elmalk10bot"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تواصل السورس' then
local Text = [[
لو حابب تخش تتكلم مع المالك السورس تيمو
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝘽𝙊𝙏₎ •𖣘❩',url="t.me/TWASL_TIMO_BOT"}},
...
if text == 'مطورين السورس' then
local Text = [[ 
مطورين ومبرمجين سورس الملك اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/ttimo_2lby"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝑬𝑳𝑴𝑨𝑳𝑲₎ •𖣘 ❩', url="t.me/elmalk10"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ❨𖣘• ⁽𝘿𝙀𝙑 𝑬𝑳𝑴𝑨𝑳𝑲₎ •𖣘❩',url="t.me/elmalk10"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "تصميمات الملك" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,7); 
local Text ='تم اختيار تصميم من تصميمات الملك هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝑬𝑳𝑴𝑨𝑳𝑲₎ •𖣘 ❩', url="t.me/elmalk10"}},
{{text = '《𝚂𝙴𝙼 𝑬𝑳𝑴𝑨𝑳𝑲》',url="t.me/elmalk10"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼' then
local Text = [[ 
 🌏من أحسن السورسات على التليجرام سورس الملك 🌏
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾??𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁??𝙴 𝑬𝑳𝑴𝑨𝑳𝑲](http://t.me/elmalk10)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ', url="t.me/elmalk10"}}, 
...
if text == '𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘' then
local Text = [[ 
 🌏من أحسن السورسات على التليجرام سورس الملك 🌏
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[❨ عسليه مبرمج سورس الملك للتواصل معه اتبع الزر الاسفل ⬇️💕. ❩](t.me/elmalk10)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• 𝑻𝑰𝑴𝑶₎ •𖣘 ❩', url="t.me/ttimo_2lby"}},
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/TWASL_TIMO_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G_2/107/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
🌏 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🌏 𝘾𝙃 - [˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼](t.me/elmalk10) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب الملك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🌏 اهلا في قائمه الالعاب المتطوره سورس الملك 🌏 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/elmalk10)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌏 تم تعطيل جلب الصوره ،\n 🌏 تم قفل البوتات  ،\n 🌏 تم قفل التكرار ،\n 🌏 تم قفل الروابط ،\n 🌏 تم قفل التوجيه ،\n 🌏 تم قفل الملصقات ،\n 🌏 تم قفل المتحركه ،\n 🌏 تم قفل الفيديو ،\n 🌏 تم قفل الفشار ،\n 🌏 تم قفل الانلاين ،\n 🌏 تم قفل تعديل المديا ،\n 🌏 تم وضع التكرار  ،\n 🌏 تم قفل الفارسيه  ،\n 🌏 تم وضع الايدي بدون صوره ،n  \n 🌏 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'elmalk10')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'elmalk10')..')  ')
end,nil)   
end
if text == 'قفل الدردشه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🌏  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'elmalk10')..') \n 🌏 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌏  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'elmalk10')..') \n 🌏 تـم قفـل التاك بالكتم ')
end,nil)   
...
t = ' 🌏 ملفات السورس الملك𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅🌏𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 🌏 اهلا بك في متجر ملفات الملك\n 🌏 ملفات السورس 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n◤━───━🌏𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n 🌏 علامة تعني { ✔️ } ملف مفعل\n 🌏 علامة تعني { ✖ } ملف معطل\n 🌏 قناة سورس الملك𖣘━┅┄⟞⟦𝚂𝙾𝚄🌏𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n".." 🌏 [اضغط هنا لدخول](t.me/elmalk10) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🌏 عذرا الملف لايدعم سورس الملك\n") 
end
return false
end
...
if text == ("مسح قائمه الملك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🌏 تم مسح قائمه الملك')
return false
end

if text == 'قائمه الملك' and Sudo(msg) then
...
if text == ("رفع الملك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
if text and text:match("^رفع الملك@(.*)$") and Sudo(msg) then
local username = text:match("^رفع الملك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
if text and text:match("^رفع الملك(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الملك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
if text == ("تنزيل الملك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
if text and text:match("^تنزيل الملك@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الملك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
if text and text:match("^تنزيل الملك(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الملك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local elmalk10 = database:get(bot_id..'text:ch:user')
if elmalk10 then
send(msg.chat_id_, msg.id_,'['..elmalk10..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌏 لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'elmalk10')..')'
status  = '\n 🌏 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🌏 الـعـضو   ⇇'..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌏 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'elmalk10')..')'
...
' }\n'..' 🌏  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🌏  الرفع  ⇇{ '..setadd..
' }\n'..' 🌏  الحظر  ⇇{ '..banm..' }\n\n 🌏═───═❲[˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)❳═───═ 🌏\n 🌏 قناة سورس الملك𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\n [ ❲[˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)❳](t.me/elmalk10) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘ٴ\n 🌏 ❲[˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)❳ 🌏 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🌏 الـعـضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'elmalk10')..')'..'\n 🌏 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الملك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الملك')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس الملكو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
database:set(bot_id.."elmalk10:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."elmalk10:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."elmalk10:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."elmalk10:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_," 🌏تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."elmalk10:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."elmalk10:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس الملكيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الملك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌏♥️](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/elmalk10)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌏](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌏💕](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/elmalk10)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضحكك اهو ..🌏💕](t.me/elmalk10)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'elmalk10')..')'
local iduser = result.sender_user_id_
...
[[
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘iD ⇨ #id 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🌏  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast 🌏  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs 🌏  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@elmalk10↜ 🌏  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
🌏 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_,msg.id_,'\n 🌏 اهلا عزيزي البوت هنا ادمن'..'\n 🌏 وصلاحياته هي 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘 \n━━━━━━━━━━'..'\n 🌏 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 🌏 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 🌏 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 🌏 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 🌏 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 🌏 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
[🎯ألعاب سورس الملك الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)
]]
keyboard = {} 
...
Text_Games = [[
《𝚆𝙴𝙻𝙲𝙾𝙼 𝙸𝙽 𝑬𝑳𝑴𝑨𝑳𝑲 𝙶𝙰𝙼𝙴𝚂🎮》
≪━━━━━━⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧━━━━━━≫
✰مرحب بيك في قائمه العاب سورس الملك🎮
≪━━━━━━⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧━━━━━━≫
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨??𝑲',url="t.me/elmalk10"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)❳ 
]]
keyboard = {} 
...
local Teext =[[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧⟝┄┉━𖣘
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[˹《𝚂𝙾𝚄𝚁𝙲𝙴 𝑬𝑳𝑴𝑨𝑳𝑲》˼ ](t.me/elmalk10)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الملك')
